...
<img src="logo.png" alt="MOH CAFÉ" class="loader-logo">
...
// Hide as soon as the DOM/content is ready instead of waiting on every
// external resource (fonts, embeds, images) — this is what was causing
// the loader to get stuck and hide the hero section on slower mobile
// connections.
setTimeout(hideLoader,1200);

// Hard safety net: never let the loader stay up longer than this,
// no matter what is still loading in the background.
